...
static const char *usb_strings[] = {
	"COHERENT RTLSDR - DFU",
	"Reference noise controller firmware update",
	"I_AM_A_WIZARD",
...
//UNNEEDED. MY INITIAL ATTEMPTS TO COMPILE THIS AS A WHOLE AND HAVE DFU-APP IN A NAMED SECTION. DID NOT ACCOMPLISH THIS...
//NEEDED TWO VECTOR TABLES. MAYBE SOME DAY... what is now main was dfu_main() and bootloader.c code was main here.
...
//Modified from libopencm3 reset_handler(). We place this initializer function in our named segment, call it when we need jump to DFU.
void __attribute__ ((section(".dfu"))) reset_to_dfu(void)
{
